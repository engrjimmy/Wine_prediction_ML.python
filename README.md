# Machine_learning_wine_prediction
The data was downloaded from UCI Machine Learning Repository. Here we go : https://archive.ics.uci.edu/ml/datasets/wine+quality 
